...
var fs = require('fs'),
    ...
    path = require('path'),
    bl = require('bl'); // THIS IS A COLLECTION OF NODE BUFFERS???????
...
function log() {
    ...
    LOG && console.log.apply(console, args);
}
...
exports.create = function (config) {
    ...
    return function onLoad(name, context, callback) {
        log('\n-------------- START view/dust.js (%s) -------------------------\n',name);
        log('engine-munger:view/dust:fn(\n\tname = %s,\n\tcontext = %s,\n\tcb = %s)',name,'<context>','<callback>');
        ...
        log('engine-munger:view/dust: \n\tglobal = %s,\n\tlocals = %s,\n\tlocality = %s,\n\tprops = %s,\n\toptions = %s)',global,locals,locality,props,options);
        ...
        out = bl(function (err, data) {
            ...
            try {
                ...
                log('Compiled dust for name = %s', name);
