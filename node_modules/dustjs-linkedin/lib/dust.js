...
(function(root) {
  ...
  Chunk.prototype.partial = function(elem, context, params) {
    ...
    if(typeof elem === 'string') {
      console.log('Chunk.prototype.partial typeof elem === "string" : set templateName to %s', elem)      
    ...
    if (typeof elem === 'function') {
      partialChunk = this.capture(elem, partialContext, function(name, chunk) {
        console.log('Chunk.prototype.partial typeof elem === "function" : set templateName to %s', partialContext.templateName || name)        
