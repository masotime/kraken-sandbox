...
(function(root) {
  ...
  function Context(stack, global, blocks, templateName) {
    ...
    this.global = global;
    this.blocks = blocks;
    console.log('function Context(stack....): set templateName to %s', templateName)
  ...
  Chunk.prototype.partial = function(elem, context, params) {
    ...
    if(typeof elem === 'string') {
      console.log('Context.prototype.partial typeof elem === "string" : set templateName to %s', elem)
    ...
    if (typeof elem === 'function') {
      partialChunk = this.capture(elem, partialContext, function(name, chunk) {
        console.log('Context.prototype.partial typeof elem === "function" : set templateName to %s', partialContext.templateName || name)
